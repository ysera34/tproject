 ...
 */
public class ContentT2ListFragment extends Fragment {

    private static final String ARG_CONTENT_TYPE = "content_type";

    private RecyclerView mContentT2RecyclerView;
    private ContentAdapter mContentAdapter;
    private ArrayList<Content> mContents;
    int mContentType;

    public static ContentT2ListFragment newInstance(int type) {

        Bundle args = new Bundle();
        args.putSerializable(ARG_CONTENT_TYPE, type);

        ContentT2ListFragment fragment = new ContentT2ListFragment();
        fragment.setArguments(args);
        return fragment;
    }

    public ContentT2ListFragment() {
    }
...
//        return super.onCreateView(inflater, container, savedInstanceState);
        View view = inflater.inflate(R.layout.fragment_content_t2, container, false);

        mContentT2RecyclerView = (RecyclerView) view.findViewById(R.id.content_type2_recycler_view);
        mContentT2RecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
    ...
    private void updateUI() {
        ...
        if (mContentAdapter == null) {
            ...
            mContentT2RecyclerView.setAdapter(mContentAdapter);
        } else {
