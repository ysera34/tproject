 ...
 */
public class ArchiveContentT3ListFragment extends Fragment {

    private static final String ARG_CONTENT_TYPE = "content_type";

    private RecyclerView mArchiveContentT3RecyclerView;
    ...
    public ArchiveContentT3ListFragment() {
    }
...
//        return super.onCreateView(inflater, container, savedInstanceState);
        View view = inflater.inflate(R.layout.fragment_archive_content_t3, container, false);

        mArchiveContentT3RecyclerView = (RecyclerView) view.findViewById(R.id.archive_content_type3_recycler_view);
        mArchiveContentT3RecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
    ...
    private void updateUI() {
        ...
        if (mContentAdapter == null) {
            ...
            mArchiveContentT3RecyclerView.setAdapter(mContentAdapter);
        } else {
