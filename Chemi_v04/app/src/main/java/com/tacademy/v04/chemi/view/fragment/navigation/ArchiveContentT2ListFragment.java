 ...
 */
public class ArchiveContentT2ListFragment extends Fragment {

    private static final String ARG_CONTENT_TYPE = "content_type";

    private RecyclerView mArchiveContentT2RecyclerView;
    ...
    public ArchiveContentT2ListFragment() {
    }
...
//        return super.onCreateView(inflater, container, savedInstanceState);
        View view = inflater.inflate(R.layout.fragment_archive_content_t2, container, false);

        mArchiveContentT2RecyclerView = (RecyclerView) view.findViewById(R.id.archive_content_type2_recycler_view);
        mArchiveContentT2RecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
    ...
    private void updateUI() {
        ...
        if (mContentAdapter == null) {
            ...
            mArchiveContentT2RecyclerView.setAdapter(mContentAdapter);
        } else {
