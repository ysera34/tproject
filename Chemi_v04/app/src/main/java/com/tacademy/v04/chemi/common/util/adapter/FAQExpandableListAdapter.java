...
public class FAQExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = layoutInflater.inflate(R.layout.list_item_faq_header, null);
        }

        TextView textView = (TextView) view.findViewById(R.id.list_item_faq_header_text_view);
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            LayoutInflater layoutInflater = LayoutInflater.from(viewGroup.getContext());
            view = layoutInflater.inflate(R.layout.list_item_faq_body, null);
        }

        TextView textView = (TextView) view.findViewById(R.id.list_item_faq_body_text_view);
