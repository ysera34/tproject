 ...
 */
public class ContentT1ListFragment extends Fragment {

    private static final String ARG_CONTENT_TYPE = "content_type";

    private RecyclerView mContentT1RecyclerView;
    private ContentAdapter mContentAdapter;
    private ArrayList<Content> mContents;
    int mContentType;

    public static ContentT1ListFragment newInstance(int type) {

        Bundle args = new Bundle();
        args.putSerializable(ARG_CONTENT_TYPE, type);

        ContentT1ListFragment fragment = new ContentT1ListFragment();
        fragment.setArguments(args);
        return fragment;
    }

    public ContentT1ListFragment() {
    }
...
//        return super.onCreateView(inflater, container, savedInstanceState);
        View view = inflater.inflate(R.layout.fragment_content_t1, container, false);

        mContentT1RecyclerView = (RecyclerView) view.findViewById(R.id.content_type1_recycler_view);
        mContentT1RecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
    ...
    private void updateUI() {
        ...
        if (mContentAdapter == null) {
            ...
            mContentT1RecyclerView.setAdapter(mContentAdapter);
        } else {
