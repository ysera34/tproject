...
//        return super.onCreateView(inflater, container, savedInstanceState);
        ...
        mProductTotalTextView = (TextView) view.findViewById(R.id.product_list_total_text_view);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mProductTotalTextView.setText(
                getString(R.string.product_list_total, String.valueOf(mProducts.size())));
